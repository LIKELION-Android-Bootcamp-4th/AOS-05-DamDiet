  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      items: [
        ...
        BottomNavigationBarItem(
          icon: SvgPicture.asset('assets/icons/ic_community_outline.svg', width: 20, height: 20),
          activeIcon: SvgPicture.asset('assets/icons/ic_community_fill.svg', width: 20, height: 20),
          label: '커뮤니티',
        ),
        BottomNavigationBarItem(
